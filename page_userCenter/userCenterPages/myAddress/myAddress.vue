<template>
	<view>
		...
		<navigator url="/page_userCenter/userCenterPages/myAddress/addeditAddress"><button @click="addAddress" class="addBtn cu-btn">新增地址</button></navigator>
		<u-toast ref="uToast" />
	</view>
</template>
...
export default {
	...
	methods: {
		...
		editAddress(data) {
			...
			uni.navigateTo({
				url:`/page_userCenter/userCenterPages/myAddress/addeditAddress?id=${data}`,
				fail:(err)=>{
					console.log(err);
				}
			})

<template>
	<view style="padding: 20px;">
		<view class=""><h1>首页</h1></view>
		<view class=""><h1>uView 按钮</h1></view>
		...
		<view class=""><h1>colorUI 按钮 参考官方实例查看</h1></view>
		<button style="background-color: red;" class="cu-btn round">圆角</button>
